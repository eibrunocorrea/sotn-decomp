...
INCLUDE_ASM("boss/bo2/nonmatchings/unk_224DC", EntityMinotaurFireball);

INCLUDE_ASM("boss/bo2/nonmatchings/unk_224DC", EntityMinotaurSpitLiquid);

INCLUDE_ASM("boss/bo2/nonmatchings/unk_224DC", EntityMinotaurDeathPuff);
