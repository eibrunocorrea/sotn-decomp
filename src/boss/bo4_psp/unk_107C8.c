...
void func_pspeu_0924EA50_from_rbo5(s32 arg0);
...
void func_pspeu_09248898_from_rbo5(void) {
    u16 var_s0;
    s32 anim;
    ...
    if (func_pspeu_0924EA98_from_rbo5(0x4301C) == 0) {
        MarDecelerateX_0925B090(FIX(0.125));
        switch (MARIA.step_s) {
        case 0:
        case 2:
            break;
        ...
        if (var_s0 & 1 && MarCheckFacing() != 0) {
            func_pspeu_0924CBF0_from_rbo5(0);
            var_s0 |= 0x8000;
        }
...
void func_pspeu_09248FA8_from_rbo5(void) {
    s16 var_s0;
    s32 anim;
    ...
    if (func_pspeu_0924EA98_from_rbo5(0x100C) == 0) {
        MarDecelerateX_0925B090(FIX(0.125));
        switch (MARIA.step_s) {
        case 0:
            var_s0 = 6;
        ...
        if (var_s0 & 0x20) {
            func_pspeu_0924C9C8_from_rbo5(0, 0);
            var_s0 |= 0x8000;
        }
...
// local copy of CheckWingSmashInput (see bo4/unk_46E7C.c)
s32 func_pspeu_0924AAF0_from_rbo5(void) {
...
void func_pspeu_0924B918_from_rbo5(void) {
    ...
    MARIA.drawFlags = ENTITY_ROTATE;
    MarDecelerateX_0925B090(FIX(1.0 / 8.0));
    if (g_Maria.vram_flag & (TOUCHING_CEILING | TOUCHING_GROUND)) {
        MARIA.velocityY = 0;
    }
    MarDecelerateX_0925B130(FIX(1.0 / 8.0));
    func_pspeu_0924AA18_from_rbo5(0);
    count = 0;

    switch (MARIA.step_s) {
    case 0:
        for (i = 0; i < 4; i++) {
            if (g_MarSensorsFloor[i].y < D_pspeu_0926B230[i]) {
                g_MarSensorsFloor[i].y++;
            } else {
                count++;
            }
            if (g_MarSensorsCeiling[i].y > D_pspeu_0926B228[i]) {
...
void func_pspeu_0924C200_from_rbo5(void) {
    s32 i;
    s32 count;
    ...
    MarDecelerateX_0925B090(FIX(1.0 / 128.0));
    MarDecelerateX_0925B130(FIX(1.0 / 128.0));
    count = 0;
...
extern s16 D_pspeu_0926B198[];
extern s32 D_pspeu_0926CE10;
// local copy of DopplegangerStepStone (see bo4/unk_46E7C.c)
void func_pspeu_0924C550_from_rbo5(s32 arg0) {
    switch (MARIA.step_s) {
    case 0:
        func_pspeu_09249838_from_rbo5();
        func_80159C04();
        MARIA.velocityY = FIX(-4);
        func_pspeu_0924EA50_from_rbo5(FIX(-0.625));
        func_pspeu_092497C0_from_rbo5();
    ...
    case 1:
        func_pspeu_0924E788_from_rbo5(1, 4);
        MARIA.palette = PAL_FLAG(PAL_CC_STONE_EFFECT);
        if (func_pspeu_0924EA98_from_rbo5(0x20280) != 0) {
    ...
    case 3:
        if (MARIA.poseTimer < 0) {
            ...
            MARIA.rotPivotX = 0;
            MARIA.drawFlags |= ENTITY_ROTATE;
            MARIA.rotate = D_pspeu_0926B198[MARIA.poseTimer] >> 0x4;
            if (MARIA.rotate) {
                MARIA.rotPivotY = 20;
            } else {
                MARIA.rotPivotY = 24;
