...
/*
 * RNO2's breakable is a variant of e_breakable_with_debris.h for the inverted
 * castle: the double wall candelabra hangs upside down (rotate 180°) and is
 * restored upright when broken, and the bust drops a heart like the urn and
 * jug instead of leaving debris behind.
 */
...
void EntityBreakable(Entity* self) {
    ...
    if (!self->step) {
        ...
        if (breakableType == CANDELABRA_WALL_DOUBLE) {
