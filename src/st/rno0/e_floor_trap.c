...
// Donor: src/st/rnz0/e_floor_trap.c (fully matched). Same entity,
...
void EntityFloorTrap(Entity* self) {
    ...
    case FLOORTRAP_INIT:
        ...
        if (self->params & PARAMS_IS_WHEEL) {
            ...
            if (other != NULL) {
                CreateEntityFromEntity(E_FLOOR_TRAP, self, other);
    ...
    case FLOORTRAP_1:
        ...
        if (other->entityId == E_FLOOR_TRAP) {
    ...
    case IM_A_WHEEL:
        ...
        if (other->velocityX != 0) {
            ...
            // is the wheel
            AnimateEntity(D_us_80181DC4, self);
        }
        break;
